...
if (Array.isArray(elementos)) {
  ...
  setDatos(informacionFormulario)
...
<div class="alert alert-warning  col-lg-4 col-md-10 col-8 mx-auto" role="alert" style={{textAlign:"center"}}>
  <div >
    <h4 style={{textAlign:"center",color:"Black"}} >Agrega tu Receta favorita
        </h4>
  </div>
</div>
                    ...
                    <div className="col-lg-8 col-12 mx-auto">
                        ...
                        <div className="tab-content shadow-lg mt-5" id="nav-tabContent">
                            <div className="tab-pane fade show active" id="nav-ContactForm" role="tabpanel"
                                ...
                                <form onSubmit={datosDelFormulario} className="custom-form contact-form mb-5 mb-lg-0" action="#" 
                                    role="form">
                                    <div className="contact-form-body">
                                        <div className="row">
                                            <div className="col-6 col-10 col-12 mx-auto">
                                                <input type="text" name="contact-name" id="receta"
                                                    className="form-control" placeholder="receta" required/>
                                            </div>
