                ...
                return (
                  <div className="col-4">
                    ...
                    >
                      <img
                        src={recetas.imagen}
                        className="card-img-top w-75 img-fluid img-thumbnail card-img-top mx-auto mt-2"
                        alt="imagen"
                      />
                      <div
                        class="card-body"
                        style={{ marginBottom: "50px", margin: "10px" }}
                      >
                        <h5 class="card-title">{recetas.receta}</h5>
                        <p class="card-text">{recetas.instruciones}</p>
                      </div>
                      <ul
                      ...
                      >
                        ...
                        <li class="list-group-item">{recetas.ingrediente4}</li>
                        <button
